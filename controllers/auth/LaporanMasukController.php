...
class IncomingGoodsReportController {
    ...
    public function index($search = '', $start_date = '', $end_date = '') {
        ...
        // Contoh join antar tabel (silakan sesuaikan dengan nama tabel kamu)
        $sql = "
            SELECT 
                d.tanggal,
                u.nama_petugas,
    ...
    public function exportPDF($rows, $filters = []) {
        ...
        $pdf->SetFont('helvetica', 'B', 10);
        $pdf->Cell(135, 7, 'Total Barang Masuk', 1);
...
// ====== Eksekusi controller ======
$laporan = new IncomingGoodsReportController($conn);
...
// Panggil view
include __DIR__ . '/../views/report/IncomingGoodsReport.php';
