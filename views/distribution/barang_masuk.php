...
<div class="ml-64 p-6 min-h-screen bg-gray-100">
    <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-200">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <a href="barang-masuk?action=download&type=pdf&page=<?= $page_type ?>&start_date=<?= $start_date ?>&end_date=<?= $end_date ?>&search=<?= $search ?>" 
                ...
                <a href="barang-masuk?action=download&type=excel&page=<?= $page_type ?>&start_date=<?= $start_date ?>&end_date=<?= $end_date ?>&search=<?= $search ?>" 
