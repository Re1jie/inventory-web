...
<aside class="w-64 min-h-screen bg-gray-800 text-white fixed flex flex-col justify-between">
    ...
    <div>
        ...
        <nav class="flex flex-col mt-4 space-y-1">
            ...
            <a href="<?= BASE_PATH ?>/barang-masuk" class="flex items-center gap-3 px-6 py-3 rounded-lg mx-2 transition-colors <?php echo ($current_page === BASE_PATH . '/barang-masuk') ? 'bg-indigo-600' : 'hover:bg-gray-700'; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="<?= BASE_PATH ?>/barang-keluar" class="flex items-center gap-3 px-6 py-3 rounded-lg mx-2 transition-colors <?php echo ($current_page === BASE_PATH . '/barang-keluar') ? 'bg-indigo-600' : 'hover:bg-gray-700'; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
